...
public class QuizzResultCandidateResource {
     ...
     *
     * @param quizzResultCandidate the quizzResultCandidate to create
     * @return the ResponseEntity with status 201 (Created) and with body the new quizzResultCandidate, or with status 400 (Bad Request) if the quizzResultCandidate has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/quizz-result-candidates")
    @Timed
    public ResponseEntity<QuizzResultCandidate> createQuizzResultCandidate(@RequestBody QuizzResultCandidate quizzResultCandidate) throws URISyntaxException {
        log.debug("REST request to save QuizzResultCandidate : {}", quizzResultCandidate);
        if (quizzResultCandidate.getId() != null) {
            throw new BadRequestAlertException("A new quizzResultCandidate cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     *
     * @param quizzResultCandidate the quizzResultCandidate to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated quizzResultCandidate,
     * or with status 400 (Bad Request) if the quizzResultCandidate is not valid,
     * or with status 500 (Internal Server Error) if the quizzResultCandidate couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/quizz-result-candidates")
    @Timed
    public ResponseEntity<QuizzResultCandidate> updateQuizzResultCandidate(@RequestBody QuizzResultCandidate quizzResultCandidate) throws URISyntaxException {
     ...
     *
     * @param id the id of the quizzResultCandidate to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the quizzResultCandidate, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the quizzResultCandidate to delete
